...
public class KafkaEventMapper {
  ...
  private com.jeannimi.messenger.kafka.event.ChatCreatedEvent toKafkaEvent(
  ...
  private com.jeannimi.messenger.kafka.event.ChatDeletedEvent toKafkaEvent(
      ChatDeletedEvent event) {

    return new com.jeannimi.messenger.kafka.event.ChatDeletedEvent(
        event.chatId());
  }

  private com.jeannimi.messenger.kafka.event.ChatRenamedEvent toKafkaEvent(
  ...
  private com.jeannimi.messenger.kafka.event.MessageReadEvent toKafkaEvent(
